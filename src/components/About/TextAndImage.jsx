...
function TextAndImage() {
    return (
        <div className=" flex flex-col lg:flex-row px-6 gap-y-2 lg:gap-x-16" >
            <div className="text-container mx-1 ml-3 md:ml-8 md:mx-2 flex flex-col justify-evenly gap-y-3  " >
            <h2 className="text-2xl lg:text-4xl text-start font-semibold mt-2 pt-1 " >Cultivating <span className="text-yellow-400" >Distinction</span> in Attire</h2>
            <p className=" text-lg lg:text-3xl text-start" >Our mission is to redefine fashion, infusing each design with creativity and sophistication. Why ?</p>
            ...
            <img src="about-us-img.jpg" alt="Avant Studios Img" className=" lg:w-[85%] object-center px-8 py-4 lg:py-8 lg:mt-2 " />
            </div>
        </div>
      );
}
